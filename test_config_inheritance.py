...
"""
    ...
    try:
        ...
        try:
            ...
            assert abs(float(config.learning_rate) - 1e-5) < 1e-10, f"Expected learning_rate=1e-5, got {config.learning_rate}"
...
""")
    ...
    try:
        ...
        assert abs(float(config.learning_rate) - 1e-5) < 1e-10
